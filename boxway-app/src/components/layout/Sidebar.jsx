  ...
  return (
    ...
    >
      ...
      <nav className={`flex-1 overflow-y-auto no-scrollbar py-5 space-y-6 transition-all duration-300 ${isCollapsed ? 'px-2 md:px-2' : 'px-3'}`}>
        {/* Overview */}
        <div>
          <p className={`px-4 text-xs font-bold uppercase tracking-widest text-zinc-500 mb-3 transition-all duration-300 ${isCollapsed ? 'md:hidden' : ''}`}>Overview</p>
        ...
        {/* Studio */}
        <div>
          <p className={`px-4 text-xs font-bold uppercase tracking-widest text-zinc-500 mb-3 transition-all duration-300 ${isCollapsed ? 'md:hidden' : ''}`}>Studio</p>
          <div className="space-y-1">
        ...
        {/* Finance */}
        <div>
          <p className={`px-4 text-xs font-bold uppercase tracking-widest text-zinc-500 mb-3 transition-all duration-300 ${isCollapsed ? 'md:hidden' : ''}`}>Finance</p>
          <div className="space-y-1">
        ...
        {/* Intelligence */}
        <div>
          <p className={`px-4 text-xs font-bold uppercase tracking-widest text-zinc-500 mb-3 transition-all duration-300 ${isCollapsed ? 'md:hidden' : ''}`}>Intelligence</p>
          <div className="space-y-1">
        ...
        {/* System */}
        <div>
          <p className={`px-4 text-xs font-bold uppercase tracking-widest text-zinc-500 mb-3 transition-all duration-300 ${isCollapsed ? 'md:hidden' : ''}`}>System</p>
          <div className="space-y-1">
