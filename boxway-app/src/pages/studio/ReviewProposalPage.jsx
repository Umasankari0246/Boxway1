    ...
    <div className="flex-1 overflow-y-auto bg-[#fcf9f8]">
      ...
      <div className="sticky top-0 z-20 bg-[#fcf9f8]/95 backdrop-blur border-b border-zinc-100 px-8 py-4 flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="text-xl font-black tracking-tight text-zinc-900 uppercase">{t('Review & Confirm')}</h2>
            <p className="text-[9px] font-black uppercase tracking-widest text-zinc-400">Step 4 of 4 — Final Validation</p>
          </div>
        </div>
        <div className="flex gap-3">
          <button onClick={() => navigate(-1)} className="px-5 py-2.5 border border-zinc-200 text-zinc-700 text-[10px] font-black uppercase tracking-widest hover:bg-zinc-50 transition-colors">{t('Back to Edit')}</button>
          <button onClick={handleSubmit} className="px-6 py-2.5 bg-primary text-white text-[10px] font-black uppercase tracking-widest hover:bg-black transition-colors flex items-center gap-2 shadow-lg shadow-primary/20">{t('Submit Enquiry')}<Icon name="send" className="text-[16px]" />
          </button>
        </div>
      </div>
      ...
      <div className="px-8 pb-16 pt-8 max-w-7xl">
        ...
        <div className="flex items-center justify-between mb-10">
          <div>
            <p className="text-[10px] tracking-[0.15em] uppercase text-primary font-black mb-1">{t('Step 4 of 4: Final Validation')}</p>
            <h3 className="text-4xl font-black tracking-tighter text-zinc-900">{t('Initial Enquiry')}</h3>
          ...
          <div className="flex items-center gap-2 bg-emerald-50 px-4 py-2 border border-emerald-100">
            ...
            <span className="text-[9px] font-black uppercase tracking-widest text-emerald-700">{t('All Sections Complete')}</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-12 gap-6">
          ...
          <div className="col-span-12 lg:col-span-8 space-y-6">
            ...
            <div className="bg-white p-8 border border-zinc-100 shadow-sm hover:shadow-md transition-shadow">
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h4 className="text-[10px] font-black uppercase tracking-widest">{t('Client Info')}</h4>
                </div>
                <button onClick={() => navigate(-1)} className="text-[10px] text-primary font-black uppercase tracking-widest hover:underline">{t('Edit')}</button>
              </div>
            ...
            <div className="bg-zinc-50 p-8 border border-zinc-100 shadow-sm">
              <div className="flex justify-between items-start mb-6">
                <div className="flex items-center gap-3">
                  ...
                  <h4 className="text-[10px] font-black uppercase tracking-widest">{t('Requirements & Vision')}</h4>
                </div>
                <button onClick={() => navigate(-1)} className="text-[10px] text-primary font-black uppercase tracking-widest hover:underline">{t('Edit')}</button>
              </div>
              <div className="mb-4">
            ...
            <div className="border border-zinc-200 p-6 opacity-70">
              <p className="text-[9px] font-black uppercase tracking-[0.2em] text-zinc-500 text-center mb-4">{t('Validation Log')}</p>
          ...
          <div className="col-span-12 lg:col-span-4 space-y-5">
            ...
            <div className="bg-zinc-900 text-white p-7">
              <div className="flex items-center gap-3 mb-6">
                ...
                <h4 className="text-[10px] font-black uppercase tracking-widest">{t('Project Scope')}</h4>
              </div>
              <div>
            ...
            <div className="bg-white border-l-4 border-primary p-7 shadow-sm">
              <div className="flex items-center gap-3 mb-5">
                ...
                <h4 className="text-[10px] font-black uppercase tracking-widest">{t('Financials & Timing')}</h4>
              </div>
            ...
            <div className="bg-white border border-zinc-100 p-5 shadow-sm text-center">
              <button onClick={handleSubmit} className="w-full py-3.5 bg-primary text-white text-[10px] font-black uppercase tracking-widest hover:bg-black transition-colors flex items-center justify-center gap-2">
                <Icon name="send" className="text-[16px]" />{t('Submit Enquiry')}</button>
              <button onClick={handleSaveDraft} className="w-full mt-2 py-3 border border-zinc-200 text-zinc-500 text-[10px] font-black uppercase tracking-widest hover:bg-zinc-50 transition-colors">{t('Save as Draft')}</button>
            </div>
          </div>
        </div>
      </div>
